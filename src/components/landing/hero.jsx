...
export default function hero() {
  return (
    <div>
        <img src={heropic} alt="" className='w-[100%] h-[70vh] brightness-75 relative'/>
        <div className='px-[30px] md:px-[0px] z-10 relative bottom-[300px] md:bottom-[360px] flex flex-col text-center items-center md:pr-[700px] '>
