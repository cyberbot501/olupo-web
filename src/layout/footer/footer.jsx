...
export default function Footer() {
  return (
    <div className='bg-[#013a01] flex flex-col justify-center items-center gap-10 pt-10 pb-6 px-[30px] w-full overflow-hidden'>
        <div className='flex flex-col md:flex-row justify-center items-center gap-2 md:gap-10'>
            ...
            <div className='flex flex-row w-full md:w-[360px] h-[36px] border-[1px] rounded-[20px] bg-white'>
                <input type="text" className='w-[200px] md:w-[260px] h-[36px] bg-transparent text-[#7a7777] rounded-tl-[20px] rounded-bl-[20px]'/>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-start md:pl-20 w-full'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <NavLink className='w-full md:w-[300px] text-[#7a7777] text-[13px] md:text-[16px] font-Inter font-normal underline'>
                    Show Map
                </NavLink>
            </div>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <ul className='flex flex-col gap-3'>
                    <NavLink className='text-[#7a7777] text-[13px] md:text-[16px] font-Inter font-normal'>Mon-Fri          09:00-20:00 hrs</NavLink>
                    <NavLink className='text-[#7a7777] text-[13px] md:text-[16px] font-Inter font-normal'>Saturday 09:00-20:00 hrs</NavLink>
                    <NavLink className='text-[#7a7777] text-[13px] md:text-[16px] font-Inter font-normal'>Sundays 09:00-20:00 hrs</NavLink>
                </ul>
            </div>
        </div>
